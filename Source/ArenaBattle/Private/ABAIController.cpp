...
{
	auto BehaviorTreeComponenet = Cast<UBehaviorTreeComponent>(BrainComponent);
	if (nullptr != BehaviorTreeComponenet)
	{
		BehaviorTreeComponenet->StopTree(EBTStopMode::Safe);
	}
}
